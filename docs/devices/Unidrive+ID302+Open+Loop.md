<div class="nav"><a href="/esi-data">Home</a> | <a href="/esi-data/devices">Device List</a> | Unidrive ID302 Open Loop</div>

#  Control Unidrive ID302 Open Loop

<dl>
  <dt>Type:</dt><dd>Unidrive ID302 Open Loop</dd>
  <dt>Description:</dt><dd>Unidrive ID302 Open Loop</dd>
...
<td ><pre>Unidrive ID302 Open Loop</pre></td>
</tr>
<tr >
<td class="first">PID</td>
<td ><pre>0x01010a03</pre></td>
</tr>
<tr >
...
<td ><pre><a href="HVAC+H300+Open+Loop">HVAC H300 Open Loop r512</a><br/><a href="Pump+Drive+F600+Open+Loop">Pump Drive F600 Open Loop r512</a><br/><a href="Unidrive+ID300+Open+Loop">Unidrive ID300 Open Loop r512</a></pre></td>
</tr>
