...
<tr class="txpdo">
<td class="first"><pre>  0x6001:04  Status__Frequency error         BOOL</pre></td>
</tr>
<tr class="txpdo">
<td class="first"><pre>  0x6001:05  Status__Amplitude error         BOOL</pre></td>
</tr>
<tr class="txpdo">
...
<tr class="txpdo pdosection">
<td class="first"><pre>0x1a01: ENC Frequency (int32)</pre></td>
</tr>
<tr class="txpdo">
<td class="first"><pre>  0x6000:1b  Frequency value (int32)         DINT</pre></td>
</tr>
<tr class="txpdo pdosection">
<td class="first"><pre>0x1a02: ENC Frequency (uint32)</pre></td>
</tr>
<tr class="txpdo">
