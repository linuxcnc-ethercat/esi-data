...
<tr class="txpdo">
<td class="first"><pre>  0x6000:01  Latch C valid                   BOOL</pre></td>
<td  colspan=5 align="left"><pre>  0x6000:01  Status__Latch C valid           BOOL</pre></td>
</tr>
<tr class="txpdo">
<td class="first"><pre>  0x6000:02  Latch extern valid              BOOL</pre></td>
...
<tr class="txpdo pdosection">
<td class="first" colspan=6 align="left"><pre>0x1a01: ENC Inputs</pre></td>
</tr>
<tr class="txpdo">
<td class="first"><pre>  0x6000:01  Latch C valid                   BOOL</pre></td>
<td  colspan=5 align="left"><pre>  0x6000:01  Status__Latch C valid           BOOL</pre></td>
...
<tr class="txpdo pdosection">
<td class="first" colspan=6 align="left"><pre>0x1a02: ENC Inputs</pre></td>
</tr>
<tr class="txpdo">
<td class="first" colspan=6 align="left"><pre>  0x6000:14  Period value                    UDINT</pre></td>
</tr>
<tr class="txpdo pdosection">
<td class="first" colspan=6 align="left"><pre>0x1a03: ENC Inputs</pre></td>
</tr>
<tr class="txpdo">
<td class="first" colspan=6 align="left"><pre>  0x6000:13  Frequency value                 UDINT</pre></td>
</tr>
<tr class="txpdo pdosection">
<td class="first" colspan=6 align="left"><pre>0x1a04: ENC Inputs</pre></td>
</tr>
<tr class="txpdo">
<td class="first" colspan=6 align="left"><pre>  0x6000:16  Timestamp                       ULINT</pre></td>
</tr>
<tr class="txpdo pdosection">
<td class="first" colspan=6 align="left"><pre>0x1a05: ENC Inputs</pre></td>
</tr>
<tr class="txpdo">
<td class="first" colspan=5 align="left"><pre>  0x6000:16  Timestamp                       DWORD</pre></td>
...
<tr class="rxpdo">
<td class="first"><pre>  0x7000:01  Enable latch C                  BOOL</pre></td>
<td  colspan=5 align="left"><pre>  0x7000:01  Control__Enable latch C         BOOL</pre></td>
</tr>
<tr class="rxpdo">
<td class="first"><pre>  0x7000:02  Enable latch extern on positive edge  BOOL</pre></td>
...
<tr class="rxpdo">
<td class="first"><pre>  0x7000:04  Enable latch extern on negative edge  BOOL</pre></td>
...
<tr class="rxpdo pdosection">
<td class="first" colspan=6 align="left"><pre>0x1601: ENC Outputs</pre></td>
</tr>
<tr class="rxpdo">
<td class="first"><pre>  0x7000:01  Enable latch C                  BOOL</pre></td>
<td  colspan=5 align="left"><pre>  0x7000:01  Control__Enable latch C         BOOL</pre></td>
